...
public class SeleniumTraining extends ExtentReports {
	WebDriver driver;
@Test()
	public  void documentverification() throws InterruptedException {
		...
		driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[37]"));

		List<WebElement> opt2 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[37]"));
		int s2 = opt2.size();
		// Iterating through the list selecting the desired option
		...
		driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li"));
		Thread.sleep(2000);
		List<WebElement> opt3 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li"));
		int s3 = opt3.size();
		// Iterating through the list selecting the desired option
		...
		driver.findElement(By.xpath("//*[@type='text']//following::input[2]")).sendKeys(" houseno:97A");
		driver.findElement(By.xpath("//*[@type='text']//following::input[3]")).sendKeys("Chennai");
		driver.findElement(By.xpath(("//*[@type='text']//following::input[4]"))).sendKeys("600060");
		...
		driver.findElement(By.xpath("//*[@type='text']//following::input[10]")).sendKeys("566678ojkkp");
		 ...
		 */
		//datepicker//
		WebElement dateBox = driver.findElement(By.xpath("//*[@type='date']"));
		dateBox.sendKeys("09052000");
		...
		// checkBoxElement.click();
		  ...
		  boolean isDisplayed = checkBoxElement.isDisplayed();
		   ...
		   wait.until(ExpectedConditions.visibilityOfElementLocated(
					...
					.click();
			driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[1]"));
			List<WebElement> opt6 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[1]"));
			Thread.sleep(2000);
			int s6 = opt6.size();
			// Iterating through the list selecting the desired option
			for (int e = 0; e < opt6.size(); e++) {
				...
				if (opt6.get(e).getText().equals("testing")) {  
					opt6.get(e).click();
					break;
				}}
			wait.until(ExpectedConditions.visibilityOfElementLocated(
					...
					.click();
			driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[5]"));
			List<WebElement> opt7 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[5]"));
			Thread.sleep(2000);
			int s7 = opt7.size();
			// Iterating through the list selecting the desired option
			...
			driver.findElement(By.xpath(("//*[@type='text']//following::input[27]"))).sendKeys("600060");
			...
			Thread.sleep(3000);
			  driver.findElement(By.id((":r14:"))).  
			  sendKeys("Business");
			  //Thread.sleep(1000);
				/*
				 * driver.findElement(By.xpath((
				 * "//*[@id="root"]/main/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[12]/div[2]/div/div"
				 * ))). sendKeys("check voter ID");
				 */
				/*
					  ...
					  boolean isDisplayed2 = checkBoxElement2.isDisplayed();
					   ...
					   WebDriverWait wait12 = new WebDriverWait(driver, 60);
						wait.until(ExpectedConditions.visibilityOfElementLocated(
								...
								.click();
						driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[1]"));
						List<WebElement> opt12 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[1]"));
						Thread.sleep(2000);
						int s12 = opt12.size();
						// Iterating through the list selecting the desired option
						for (int d = 0; d< opt11.size(); d++) {
							...
							if (opt12.get(d).getText().equals("testing")) {
								opt12.get(d).click();
								break;
							}}
						//driver.findElement(By.xpath(("//*[@type='text']//following::input[27]"))).sendKeys("600050");
// for query type office
						wait.until(ExpectedConditions.visibilityOfElementLocated(
								By.xpath("//*[@id=\"root\"]/main/div/div[2]/div[2]/div[1]/div[1]/div[2]/div[17]/div/div/div")))
								.click();
						driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[4]"));
						List<WebElement> opt14 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li[4]"));
						Thread.sleep(2000);
						int s14 = opt14.size();
						// Iterating through the list selecting the desired option
						for (int m= 0; m< opt14.size(); m++) {
							// if the option is By Subject click that option

							if (opt14.get(m).getText().equals("vehcile loan document")) {
								opt14.get(m).click();
								break;
							}}
						...
						wait.until(ExpectedConditions.visibilityOfElementLocated(
								By.xpath("//*[@id=\"root\"]/main/div/div[2]/div[2]/div[1]/div[4]/div[2]/div/div")))
								.click();
						driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li"));
						List<WebElement> opt13 = driver.findElements(By.xpath("//*[@id=\"menu-\"]/div[3]/ul/li"));
						Thread.sleep(2000);
						int s13 = opt13.size();
						// Iterating through the list selecting the desired option
						for (int t = 0; t< opt13.size(); t++) {
							...
							if (opt13.get(t).getText().equals("Sara G")) {
								opt13.get(t).click();
								break;
							}}
